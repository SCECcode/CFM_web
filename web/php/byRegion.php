...
$query = "SELECT OBJECT_tb.gid,OBJECT_tb.name FROM OBJECT_tb,REGION_tb where REGION_tb.abb=$1 and REGION_tb.gid=OBJECT_tb.REGION_tb_gid";
...
echo "<div data-side=\"resultByRegion\" data-params=\"";
echo $resultstring;
