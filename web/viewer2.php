...
--->
            ...
            <div class="row">
                <div class="col input-group">
                    <ul id="sidebar" class="navigation pl-2 pb-2 pr-1 pt-2" style="background:whitesmoke; display:none">
                        ...
                        <li id='latlon' class='navigationLi ' style="display:none">
                            <div id='latlonMenu' class='menu'>
                                ...
                                <div class="row d-flex ">
                                    ...
                                    <div class="col-0 pr-0 align-items-center">
        ...
        <div id="result-block" class="col-12" >
          ...
          <div class="button-container d-flex flex-column" style="overflow:hidden">
            ...
            <div id="searchResult" class="mb-1" style="overflow:hidden"></div>
<!--
            <div id="phpResponseTxt"></div>
-->
          </div>
...
--->
          ...
          <div class="row mapData">
            <div class="col-12 pr-0 pl-20 pt-1">
              <div class="row w-100 mb-1" id='CFM_plot'
                 style="position:relative;border:solid 1px #ced4da; height:600px;"></div>
