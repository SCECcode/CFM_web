...
<div class="container info-page-container scec-main-container guide">
    ...
    <div>
        ...
        <p>The SCEC Community Fault Model (CFM) is an object-oriented, three-dimensional representation of more than 150
            ...
            objects which include triangulated surface representations (t-surfs) of these faults and associated meta
            data.
        ...
        <p> The model serves the Southern California Earthquake Center (SCEC) as a unified resource for physics-based
            fault
            systems modeling, strong ground-motion prediction, and probabilistic seismic hazards assessment (e.g.,
            UCERF3).
        ...
        <p> The latest release of the CFM is version 5.2, which includes many new and revised fault representations
            (Nicholson et al., 2017). In addition, the new model expands and improves the database component of CFM to
            help
            ensure the internal consistency and maintainability of the model. This hierarchical name and numbering
            system
            enables model users to access and assess the full richness of the various fault systems, 3D fault models,
            and 3D
            fault components in CFM. In addition to fault area, fault system, fault section and fault name, the expanded
            CFM
            database now includes fields for alternate and CFM version number, source, descriptor, references, USGS
            Quaternary fault (Qfault) ID, and fault attributes of average strike, dip, area, and faulting style. Care
            was
    ...
    <div>
        ...
        <ul class="references">
            <li><a href="https://www.scec.org/user/nicholson">Nicholson, C.</a>, <a
                ...
                Model Version 5.2: Updating &amp; expanding the CFM 3D fault set and its associated fault database.
                Poster
                Presentation at 2017 SCEC Annual Meeting.&nbsp; <a href="https://www.scec.org/publication/7735">SCEC
                    Contribution 7735</a></li>
            <li><a href="https://www.scec.org/user/plesch">Plesch, A.</a>, et al. (2007). "Community Fault Model (CFM)
                for
