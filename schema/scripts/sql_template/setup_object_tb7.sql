COPY OBJECT_tb(name,source_author,last_update,w_avg_strike,w_avg_dip,total_area_km2,exposure,slip_sense,ID_comments,USGS_ID,fault_strand_model_description,reference) FROM '/home/postgres/CFM/schema/data/DATATYPE/object_tb_base.csv' DELIMITER ',' CSV HEADER;
