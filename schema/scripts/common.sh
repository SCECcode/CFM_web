...
then
  ...
  CFMLOC=${CFMPATH}"shp/CFM6.1_traces_Alt"
  CFMLOC_BLIND=${CFMPATH}"shp/CFM6.1_blind_Alt"
  CFMTYPE="CFM6_alternatives"
  EXCEL_NM="CFM6.1_Metadata_Alt"
  EXCEL_NM_SHEET="CFM6.1 Alternatives"
  EXCEL_NM_FILE=${PWD}"/../CFM6/doc/CFM6.1_Metadata.xlsx"
...
## CFM6/doc/CFM6.1_Metadata.csv
if [ $TOGGLE_P6 == 1 ]
then
  CFMPATH=${PWD}"/../CFM6/"
  CFMLOC=${CFMPATH}"shp/CFM6.1_traces"
  CFMLOC_BLIND=${CFMPATH}"shp/CFM6.1_blind"
