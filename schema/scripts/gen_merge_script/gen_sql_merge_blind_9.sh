...
UPDATE OBJECT_tb 
  SET blinds = 
    ARRAY(
       ...
       UNION ALL
       SELECT ___isblind from TRACE_tb where gid=${NINETH_TRACE_TB_GID}
    )
  WHERE TRACE_tb_gid=${SECOND_TRACE_TB_GID} OR TRACE_tb_gid=${THIRD_TRACE_TB_GID} OR 
        TRACE_tb_gid=${FOURTH_TRACE_TB_GID} OR TRACE_tb_gid=${FIFTH_TRACE_TB_GID} OR 
        TRACE_tb_gid=${SIXTH_TRACE_TB_GID} OR TRACE_tb_gid=${SEVENTH_TRACE_TB_GID} OR 
        TRACE_tb_gid=${EIGHTH_TRACE_TB_GID} OR TRACE_tb_gid=${NINETH_TRACE_TB_GID};
