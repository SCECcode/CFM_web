...
COPY OBJECT_tb(name,alternative,source_author,last_update,descriptor,avg_strike,avg_dip,area_km2,exposure,slip_sense,ID_comments,USGS_ID,fault_strand_model_description,reference) FROM '/home/postgres/CFM/schema/data/alternative/object_tb_base.csv' DELIMITER ',' CSV HEADER;
...
FROM '/home/postgres/CFM/schema/data/alternative/object_tb_head.csv' DELIMITER ',' CSV HEADER;
